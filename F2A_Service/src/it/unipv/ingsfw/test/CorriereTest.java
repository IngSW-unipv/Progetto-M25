...
public class CorriereTest {
	...
	@Before
	public void setUp() {
		corriereCompleto = new Corriere("123", "Mario", "Rossi", "RSSMRA80A01L219X", "mario.rossi@example.com",
				"password123", 1500, StatoCorriere.LIBERO);
	...
	public void testToString() {
		Corriere corriere = new Corriere("789", "Anna", "Verdi", "VRDANNA90B02M123Y", "anna.verdi@example.com",
				"securePass", 2000, StatoCorriere.LIBERO);
	...
	public void testSelectByEmailPassword() {
		assertTrue(dao.selectByEmailPassword(new Corriere("giovanni.neri@email.com", "pwd111"))); // Usa credenziali
																									// valide
	...
	public void testSelectCorriereByEmailPassword() {
		Corriere result = dao.selectCorriereByEmailPassword(new Corriere("giovanni.neri@email.com", "pwd111")); // Usa
																												// credenziali
																												// valide
		assertNotNull(result);
	...
	public void testSelectIdByEmailPassword() {
		assertEquals(corriereTest.getIdDipendente(),
				dao.selectIdByEmailPassword(new Corriere("giovanni.neri@email.com", "pwd111"))); // Usa credenziali
																									// valide
	}
